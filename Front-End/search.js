...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getMarkerIcon(loc) {
        ...
        if (type.includes('building') || name.includes('block')) {
            return 'https://imgs.search.brave.com/NZ_EWeat6nplfdM7pNRa476cWO61GMcNjXFeX-W4utc/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9jZG4t/aWNvbnMtcG5nLmZy/ZWVwaWsuY29tLzI1/Ni8xMTY1MS8xMTY1/MTU5OC5wbmc';
        }
